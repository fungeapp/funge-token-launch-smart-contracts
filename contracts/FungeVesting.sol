...
contract FungeVesting is Initializable, OwnableUpgradeable, ReentrancyGuardUpgradeable {
    ...
    */
    ...
    view
    returns(bytes32){
        require(index < getVestingSchedulesCount(), "FungeVesting: index out of bounds");
    ...
    */
    ...
    public
    {
        ...
        require(_duration > 0, "FungeVesting: duration must be > 0");
        require(_amount > 0, "FungeVesting: amount must be > 0");
        require(_slicePeriodSeconds >= 1, "FungeVesting: slicePeriodSeconds must be >= 1");
    ...
    */
    function withdraw(uint256 amount)
        ...
        nonReentrant
        onlyOwner{
        require(this.getWithdrawableAmount() >= amount, "FungeVesting: not enough withdrawable funds");
